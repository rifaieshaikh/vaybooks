...
Route column ✅ = nav/API surface. Depth notes below mark workflow parity shipped in the React+API stack (Mongo AppServices).
...
| Schedulers | ✅ | ✅ | Job edit, run history, scheduled-report configs/artifacts, module deep-links |
...
| 28 | `customizationOrders` | `boutique.orders.view` | ✅ | Boutique wave · depth ✅ workspace |
| 29 | `dashboard` | `core.dashboard.view` | ✅ | Home wave · depth ✅ drilldowns |
| 30 | `data-migration` | `migration.run` | ✅ | Migration wave · depth ✅ 4-step wizard |
...
| 61 | `measurement-detail` | `boutique.measurements.view` | ✅ | Boutique wave · depth ✅ PDF |
| 62 | `measurement-specs` | `settings.measurement_specs.view` | ✅ | |
| 63 | `measurements` | `boutique.measurements.view` | ✅ | Boutique wave · depth ✅ MeasurementForm |
| 64 | `mtd-dashboard` | `core.mtd.view` | ✅ | Home wave · depth ✅ drilldowns |
| 65 | `order-detail` | `boutique.orders.view` | ✅ | Boutique wave · depth ✅ measurement link |
| 66 | `order-workspace` | `boutique.orders.view` | ✅ | Boutique wave · depth ✅ `/boutique/orders/workspace` |
