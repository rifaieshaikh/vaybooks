...
export const SIDEBAR_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item('/projects/calendar', 'Calendar', 'projects', 'projects.projects.view', 'calendarDays'),
  ...
  },
  {
    ...
    module: 'production',
    items: [
      item('/production', 'Overview', 'production', 'production.dashboard.view', 'layoutGrid'),
      ...
      item('/production/calendar', 'Calendar', 'production', 'production.batches.view', 'calendarDays'),
      item(
