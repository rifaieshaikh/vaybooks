...
class MongoBusinessActivityRepository:
    def __init__(self, db: Database):
        self._collection = db.business_activity_configs

    def _to_doc(self, activity: BusinessActivityConfig) -> dict:
        return {
            "_id": activity.id,
    ...
    def _from_doc(self, doc: dict) -> BusinessActivityConfig:
        atype = doc.get("activity_type")
        return BusinessActivityConfig(
            id=doc["_id"],
